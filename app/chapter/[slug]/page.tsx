...
export default async function ChapterPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <div className="chaptergrid"><article className="chapter">
    ...
    {(chapter.operatingConcepts?.length||chapter.operatingStages?.length)&&<section className="operatinglayer" aria-labelledby="operating-layer-title">
