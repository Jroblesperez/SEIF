...
export const infographics = [
  ...
  {src:"/assets/assessment/07-to-be-value-stream.svg",title:"Value Stream TO-BE",caption:"Hilo conductor de valor",chapterSlug:"operating-model",sectionId:"flujo-to-be-completo"},
  {src:"/assets/assessment/08-product-operating-model.svg",title:"Product Operating Model",caption:"Arquitectura fuente del modelo propuesto",chapterSlug:"operating-model",sectionId:"arquitectura-del-product-operating-system"},
